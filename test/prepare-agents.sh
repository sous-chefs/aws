...
case "$(docker info --format '{{.Architecture}}')" in
  aarch64|arm64) arch=arm64; cloudwatch_sha=f84cbb6b193f80440f713ec3a2b2b6ed45a16f10d8f0fe38c01cbff9155cb3f9 ;;
  x86_64|amd64) arch=amd64; cloudwatch_sha=05baeadca96c4bb8e43906ed09cf0bebd0f321ff6d41987bdc46ce681de0978d ;;
